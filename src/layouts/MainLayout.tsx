...
import { IconDashboard, IconMenuFold, IconMenuUnfold, IconTag } from '@arco-design/web-react/icon';
...
function PageLayout() {
  ...
  function renderRoutes(locale) {
    ...
    return function travel(_routes: Route[], level, parentNode = []) {
      return _routes.map((route) => {
        const { breadcrumb = true, hideInMenu: ignore } = route;
        ...
        const visibleChildren = (route.children || []).filter((child) => {
          const { hideInMenu: ignore, breadcrumb = true } = child;
          if (ignore || route.hideInMenu) {
